  ...
  return (
    <div className="fixed inset-20 justify-between items-center right-96 left-96 flex flex-col shadow-[0px_2px_5px_#bab6b5] rounded-xl bg-gradient-to-br bg-white">
      ...
      <div className="w-8/12 flex flex-col items-center">
        ...
        <button className="flex self-center shadow-[0px_2px_5px_#bab6b5] mt-5 bg-blue-900 ease-in-out duration-200 hover:bg-orange-400 active:bg-blue-800 justify-center rounded-full items-center w-3/4 h-9">
